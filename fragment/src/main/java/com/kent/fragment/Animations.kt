...
/**
 * Created by abduaziz on 2020-02-23 at 04:49.
 */
...
fun exitToRight(width: Float, fragmentView: View?, backgroundView: View?, ghostView: View?, wasSwiping: Boolean): AnimatorSet {
    val animatorSet = AnimatorSet()
...
fun enterFromBottom(height: Float, fragmentView: View?, ghostView: View?): AnimatorSet {
    ...
    fragmentView?.let {
        animatorSet.playTogether(ObjectAnimator.ofFloat(fragmentView, "y", height, 0F/*height - fragmentView.height.toFloat()*/))
    }
